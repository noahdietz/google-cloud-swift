...
// limitations under the License.
  ...
  extension Clients {
    protocol RegionInstantSnapshotsStub {
      func delete(
    ...
    class RegionInstantSnapshotsTransport: RegionInstantSnapshotsStub {
      ...
      public func insert(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/instantSnapshots"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
