...
// limitations under the License.
  ...
  extension Clients {
    ...
    class RegionInstanceGroupsTransport: RegionInstanceGroupsStub {
      ...
      public func list(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/instanceGroups"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.RegionInstanceGroupList.self, from: data)
      }
      ...
      public func listInstances(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.RegionInstanceGroupsListInstances.self, from: data)
      }
