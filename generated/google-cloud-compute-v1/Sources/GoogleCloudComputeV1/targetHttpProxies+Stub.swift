...
// limitations under the License.
  ...
  extension Clients {
    protocol TargetHttpProxiesStub {
      func aggregatedList(
    ...
    class TargetHttpProxiesTransport: TargetHttpProxiesStub {
      ...
      public func aggregatedList(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/aggregated/targetHttpProxies"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.TargetHttpProxyAggregatedList.self, from: data)
      }
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable1 = request.targetHttpProxy as Swift.String?, !pathVariable1.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.targetHttpProxy' is not set or is empty")
          }
          return "/compute/v1/projects/\(pathVariable0)/global/targetHttpProxies/\(pathVariable1)"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
      ...
      public func insert(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/global/targetHttpProxies"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
