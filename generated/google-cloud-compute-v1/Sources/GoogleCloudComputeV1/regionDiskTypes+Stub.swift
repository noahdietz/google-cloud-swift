...
// limitations under the License.
  ...
  extension Clients {
    ...
    class RegionDiskTypesTransport: RegionDiskTypesStub {
      ...
      public func list(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/diskTypes"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.RegionDiskTypeList.self, from: data)
      }
    }
  }
#endif
