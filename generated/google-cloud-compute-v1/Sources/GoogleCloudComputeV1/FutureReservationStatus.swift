    ...
    Sendable
  {
    ...
    public enum AmendmentStatus: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .amendmentApproved: return try container.encode(0)
        case .amendmentDeclined: return try container.encode(1)
        case .amendmentInReview: return try container.encode(2)
