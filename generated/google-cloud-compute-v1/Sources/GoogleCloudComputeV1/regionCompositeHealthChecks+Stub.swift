...
// limitations under the License.
  ...
  extension Clients {
    protocol RegionCompositeHealthChecksStub {
      func aggregatedList(
    ...
    class RegionCompositeHealthChecksTransport: RegionCompositeHealthChecksStub {
      ...
      public func aggregatedList(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/aggregated/compositeHealthChecks"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.CompositeHealthCheckAggregatedList.self, from: data)
      }
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable2 = request.compositeHealthCheck as Swift.String?,
            !pathVariable2.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.compositeHealthCheck' is not set or is empty")
          }
          return
      ...
      public func `get`(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.CompositeHealthCheck.self, from: data)
      }
      ...
      public func getHealth(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.CompositeHealthCheckHealth.self, from: data)
      }
      ...
      public func list(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.CompositeHealthCheckList.self, from: data)
      }
