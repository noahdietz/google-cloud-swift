...
// limitations under the License.
  ...
  extension Clients {
    ...
    class FutureReservationsTransport: FutureReservationsStub {
      ...
      public func aggregatedList(
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.FutureReservationsAggregatedListResponse.self, from: data)
      }
      ...
      public func `get`(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.FutureReservation.self, from: data)
      }
      ...
      public func list(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.FutureReservationsListResponse.self, from: data)
      }
