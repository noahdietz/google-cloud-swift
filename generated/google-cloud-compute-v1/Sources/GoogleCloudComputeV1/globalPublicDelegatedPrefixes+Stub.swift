...
// limitations under the License.
  ...
  extension Clients {
    ...
    class GlobalPublicDelegatedPrefixesTransport: GlobalPublicDelegatedPrefixesStub {
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable1 = request.publicDelegatedPrefix as Swift.String?,
      ...
      public func insert(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/global/publicDelegatedPrefixes"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
