...
// limitations under the License.
  ...
  public struct NetworkEndpointGroupList: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    ...
    Sendable
  {
    ...
    /// Output only. [Output Only] The resource type, which is always compute#networkEndpointGroupList for network endpoint group lists.
