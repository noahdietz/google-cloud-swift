  ...
  extension Clients {
    ...
    class InterconnectsTransport: InterconnectsStub {
      ...
      public func `get`(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.Interconnect.self, from: data)
      }
      ...
      public func getDiagnostics(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.InterconnectsGetDiagnosticsResponse.self, from: data)
      }
      ...
      public func getMacsecConfig(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.InterconnectsGetMacsecConfigResponse.self, from: data)
      }
      ...
      public func list(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.InterconnectList.self, from: data)
      }
