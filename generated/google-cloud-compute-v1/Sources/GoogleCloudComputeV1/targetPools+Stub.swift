  ...
  extension Clients {
    ...
    class TargetPoolsTransport: TargetPoolsStub {
      ...
      public func aggregatedList(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.TargetPoolAggregatedList.self, from: data)
      }
      ...
      public func `get`(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.TargetPool.self, from: data)
      }
      ...
      public func getHealth(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.TargetPoolInstanceHealth.self, from: data)
      }
      ...
      public func list(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.TargetPoolList.self, from: data)
      }
