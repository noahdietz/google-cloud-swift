...
// limitations under the License.
  ...
  extension Clients {
    ...
    class StoragePoolTypesTransport: StoragePoolTypesStub {
      ...
      public func aggregatedList(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/aggregated/storagePoolTypes"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.StoragePoolTypeAggregatedList.self, from: data)
      }
      ...
      public func `get`(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable2 = request.storagePoolType as Swift.String?, !pathVariable2.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.storagePoolType' is not set or is empty")
          }
          return
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.StoragePoolType.self, from: data)
      }
      ...
      public func list(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/zones/\(pathVariable1)/storagePoolTypes"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.StoragePoolTypeList.self, from: data)
      }
    }
  }
#endif
