...
// limitations under the License.
  ...
  extension Clients {
    ...
    class DiskTypesTransport: DiskTypesStub {
      ...
      public func aggregatedList(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/aggregated/diskTypes"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.DiskTypeAggregatedList.self, from: data)
      }
      ...
      public func `get`(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable2 = request.diskType as Swift.String?, !pathVariable2.isEmpty else {
            throw GoogleCloudGax.RequestError.binding("'request.diskType' is not set or is empty")
          }
          return
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.DiskType.self, from: data)
      }
      ...
      public func list(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/zones/\(pathVariable1)/diskTypes"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.DiskTypeList.self, from: data)
      }
    }
  }
#endif
