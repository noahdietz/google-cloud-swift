...
// limitations under the License.
  ...
  extension Clients {
    protocol GlobalForwardingRulesStub {
      func delete(
    ...
    class GlobalForwardingRulesTransport: GlobalForwardingRulesStub {
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable1 = request.forwardingRule as Swift.String?, !pathVariable1.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.forwardingRule' is not set or is empty")
          }
          return "/compute/v1/projects/\(pathVariable0)/global/forwardingRules/\(pathVariable1)"
        }()
        var query = [
      ...
      public func insert(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/global/forwardingRules"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
