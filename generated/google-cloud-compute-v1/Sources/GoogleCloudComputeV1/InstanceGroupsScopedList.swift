...
// limitations under the License.
  ...
  public struct InstanceGroupsScopedList: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    /// Output only. [Output Only] The list of instance groups that are contained in this scope.
