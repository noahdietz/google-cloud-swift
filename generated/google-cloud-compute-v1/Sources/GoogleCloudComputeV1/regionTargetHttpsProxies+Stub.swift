...
// limitations under the License.
  ...
  extension Clients {
    ...
    class RegionTargetHttpsProxiesTransport: RegionTargetHttpsProxiesStub {
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable2 = request.targetHttpsProxy as Swift.String?,
      ...
      public func insert(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/targetHttpsProxies"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
