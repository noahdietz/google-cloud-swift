    ...
    Sendable
  {
    ...
    public enum RecommendationType: Codable, Equatable, Sendable {
      ...
      public var intValue: Int? {
        switch self {
        case .futureReservation: return 0
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:RecommendationType/unknownIntValue(_:)).
      public init(intValue: Int) {
        switch intValue {
        case 0: self = .futureReservation
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .futureReservation: return try container.encode(0)
