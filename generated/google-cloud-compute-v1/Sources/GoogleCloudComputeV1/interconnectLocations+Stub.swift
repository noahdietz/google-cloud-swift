    ...
    class InterconnectLocationsTransport: InterconnectLocationsStub {
      ...
      public func `get`(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable1 = request.interconnectLocation as Swift.String?,
            !pathVariable1.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.interconnectLocation' is not set or is empty")
          }
          return
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.InterconnectLocation.self, from: data)
      }
      ...
      public func list(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/global/interconnectLocations"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.InterconnectLocationList.self, from: data)
      }
    }
  }
#endif
