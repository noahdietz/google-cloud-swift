...
// limitations under the License.
  ...
  extension Clients {
    ...
    class HealthChecksTransport: HealthChecksStub {
      ...
      public func aggregatedList(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/aggregated/healthChecks"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.HealthChecksAggregatedList.self, from: data)
      }
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable1 = request.healthCheck as Swift.String?, !pathVariable1.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.healthCheck' is not set or is empty")
          }
          return "/compute/v1/projects/\(pathVariable0)/global/healthChecks/\(pathVariable1)"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
      ...
      public func insert(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/global/healthChecks"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
