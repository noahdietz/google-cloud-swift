...
// limitations under the License.
  ...
  extension Clients {
    ...
    class NetworkProfilesTransport: NetworkProfilesStub {
      ...
      public func `get`(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable1 = request.networkProfile as Swift.String?, !pathVariable1.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.networkProfile' is not set or is empty")
          }
          return "/compute/v1/projects/\(pathVariable0)/global/networkProfiles/\(pathVariable1)"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.NetworkProfile.self, from: data)
      }
      ...
      public func list(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/global/networkProfiles"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.NetworkProfilesListResponse.self, from: data)
      }
    }
  }
#endif
