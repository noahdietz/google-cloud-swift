...
// limitations under the License.
  ...
  extension Clients {
    ...
    class ReservationSubBlocksTransport: ReservationSubBlocksStub {
      ...
      public func `get`(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable3 = request.reservationSubBlock as Swift.String?,
            !pathVariable3.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.reservationSubBlock' is not set or is empty")
          }
          return
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.ReservationSubBlocksGetResponse.self, from: data)
      }
      ...
      public func list(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.ReservationSubBlocksListResponse.self, from: data)
      }
