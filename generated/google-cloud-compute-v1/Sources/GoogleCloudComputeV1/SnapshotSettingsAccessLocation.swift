    ...
    Sendable
  {
    ...
    public enum Policy: Codable, Equatable, Sendable {
      ...
      public var intValue: Int? {
        switch self {
        case .allRegions: return 0
        case .unspecified: return 1
        case .specificRegions: return 2
      ...
      public init(intValue: Int) {
        switch intValue {
        case 0: self = .allRegions
        case 1: self = .unspecified
        case 2: self = .specificRegions
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .allRegions: return try container.encode(0)
        case .unspecified: return try container.encode(1)
        case .specificRegions: return try container.encode(2)
