...
// limitations under the License.
  ...
  extension Clients {
    ...
    class SnapshotsTransport: SnapshotsStub {
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable1 = request.snapshot as Swift.String?, !pathVariable1.isEmpty else {
            throw GoogleCloudGax.RequestError.binding("'request.snapshot' is not set or is empty")
          }
          return "/compute/v1/projects/\(pathVariable0)/global/snapshots/\(pathVariable1)"
        }()
        var query = [
      ...
      public func insert(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/global/snapshots"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
      ...
      public func setLabels(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/global/snapshots/\(pathVariable1)/setLabels"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
