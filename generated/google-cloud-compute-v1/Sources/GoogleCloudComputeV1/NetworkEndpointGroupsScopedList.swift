...
// limitations under the License.
  ...
  public struct NetworkEndpointGroupsScopedList: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    /// Output only. [Output Only] The list of network endpoint groups that are contained in this scope.
