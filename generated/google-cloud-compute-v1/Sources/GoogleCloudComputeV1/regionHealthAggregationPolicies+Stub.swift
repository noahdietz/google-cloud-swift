...
// limitations under the License.
  ...
  extension Clients {
    ...
    class RegionHealthAggregationPoliciesTransport: RegionHealthAggregationPoliciesStub {
      ...
      public func aggregatedList(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/aggregated/healthAggregationPolicies"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.HealthAggregationPolicyAggregatedList.self, from: data)
      }
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable2 = request.healthAggregationPolicy as Swift.String?,
            !pathVariable2.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.healthAggregationPolicy' is not set or is empty")
          }
          return
      ...
      public func `get`(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.HealthAggregationPolicy.self, from: data)
      }
      ...
      public func list(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.HealthAggregationPolicyList.self, from: data)
      }
