...
// limitations under the License.
  ...
  extension Clients {
    ...
    class RegionBackendServicesTransport: RegionBackendServicesStub {
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable2 = request.backendService as Swift.String?, !pathVariable2.isEmpty
          else {
      ...
      public func insert(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/backendServices"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
