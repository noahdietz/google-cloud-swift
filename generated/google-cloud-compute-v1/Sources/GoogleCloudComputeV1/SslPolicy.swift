...
// limitations under the License.
  ...
  public struct SslPolicy: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    ...
    /// Output only. [Output only] Type of the resource. Always compute#sslPolicyfor SSL policies.
    ...
    /// Profile specifies the set of SSL features that can be used by the load balancer when negotiating SSL with clients. This can be one of COMPATIBLE, MODERN, RESTRICTED, FIPS_202205, or CUSTOM. If using CUSTOM, the set of SSL features to enable must be specified in the customFeatures field. If using FIPS_202205, the min_tls_version field must be set to TLS_1_2.
    ...
    private enum CodingKeys: Swift.String, CodingKey {
      ...
      case name = "name"
      case postQuantumKeyExchange = "postQuantumKeyExchange"
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.customFeatures = try container.decode([Swift.String].self, forKey: .customFeatures)
      self.description = try container.decodeIfPresent(Swift.String.self, forKey: .description)
      self.enabledFeatures = try container.decode([Swift.String].self, forKey: .enabledFeatures)
      ...
      self.warnings = try container.decode([SslPolicy.Warnings].self, forKey: .warnings)
    }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.postQuantumKeyExchange, forKey: .postQuantumKeyExchange)
