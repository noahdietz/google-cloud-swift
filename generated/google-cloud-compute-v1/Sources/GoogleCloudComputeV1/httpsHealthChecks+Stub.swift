...
// limitations under the License.
  ...
  extension Clients {
    ...
    class HttpsHealthChecksTransport: HttpsHealthChecksStub {
      ...
      public func delete(
        ...
        let path = try { () throws -> Swift.String in
          ...
          guard let pathVariable1 = request.httpsHealthCheck as Swift.String?,
            !pathVariable1.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.httpsHealthCheck' is not set or is empty")
          }
          return "/compute/v1/projects/\(pathVariable0)/global/httpsHealthChecks/\(pathVariable1)"
        }()
        var query = [
      ...
      public func `get`(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.HttpsHealthCheck.self, from: data)
      }
      ...
      public func insert(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/compute/v1/projects/\(pathVariable0)/global/httpsHealthChecks"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json"),
          URLQueryItem(name: "$apiVersion", value: "2026-03-01"),
      ...
      public func list(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudComputeV1.HttpsHealthCheckList.self, from: data)
      }
